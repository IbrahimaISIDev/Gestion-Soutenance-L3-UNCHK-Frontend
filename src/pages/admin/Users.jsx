...
export default function AdminUsers() {
  ...
  const create = useMutation({ mutationFn: createUser, onSuccess: () => { qc.invalidateQueries({ queryKey: ['users'] }); setModal(null) } })
  const update = useMutation({ mutationFn: ({ id, ...body }) => updateUser(id, body), onSuccess: () => { qc.invalidateQueries({ queryKey: ['users'] }); setModal(null) } })
